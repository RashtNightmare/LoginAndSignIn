...
{{ csrf_field() }} 
    <div class="form-group"><label id="login_label" name="login_label" style="margin-bottom:20px;font: 30px icon;text-align:left"> Test </label></div>
     ...
     <label name="l_credit_card_number" id="l_reference_id" hidden>Reference ID</label> 
  ...
  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v5H0V4zm11.5 1a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-2zM0 11v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1H0z"/>
     ...
     <input class="form-control"  id="reference_id" type="text" name="reference_id" placeholder="Reference ID"></input>
      <script>
  ...
  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v5H0V4zm11.5 1a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h2a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-2zM0 11v1a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-1H0z"/>
     ...
     <input class="form-control"  id="credit_card_number" type="text" name="credit_card_number" placeholder="Credit Card Number"></input>
      <script>
     ...
     <input class="form-control"  id="status" type="text" name="status" placeholder="Status"></input>
      <script>
           ...
           status.addEventListener('focus',function() { 
            ...
            setInterval(function () {
                const option3=status.getElementById('status')
            ...
            setInterval(function () {
                const user_id=document.getElementById('user_id')
                 if(user_id == document.activeElement){}else{
                     document.getElementById("l_user_idr").style.display="none";
                 } 
            }, 100);
      </script></div></div>      
