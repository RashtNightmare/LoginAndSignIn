...
<form method ="POST" action="\photo\{{$photos[1][0]['id']}}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
{{ csrf_field() }} 
{{ method_field('PATCH') }}

<div class="form-group"><label id="login_label" name="login_label" style="margin-bottom:20px;font: 30px icon;text-align:left"> Photo {{$photos[1][0]['id']}}</label></div>
<div class="form-group">
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
     ...
     <input class="form-control" value="{{$photos[1][0]['file_name']}}"  id="file_name" type="text" name="file_name" placeholder="File Name"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
     ...
     <input class="form-control"  value="{{$photos[0][0]['body']}}" id="body" type="text" name="body" placeholder="body"></input>
      <script>
