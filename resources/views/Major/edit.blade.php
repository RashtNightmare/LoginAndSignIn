...
<form method ="POST" action="\major\{{$majors['id']}}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
{{ csrf_field() }}
{{ method_field('PATCH') }}
    <div class="form-group"><label id="login_label" name="login_label" style="margin-bottom:20px;font: 30px icon;text-align:left"> Major {{$majors['id']}}</label></div>
     ...
     <input class="form-control"  value="{{$majors['name']}}" id="name" type="text" name="name" placeholder="Name"></input>
      <script>
