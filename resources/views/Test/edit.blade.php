...
{{ csrf_field() }}
{{ method_field('PATCH') }}
    <div class="form-group"><label id="login_label" name="login_label" style="margin-bottom:20px;font: 30px icon;text-align:left"> Test {{$tests['id']}}</label></div>
     ...
     <input class="form-control"  value="{{$tests['student_id']}}" id="student_id" type="text" name="student_id" placeholder="Student ID"></input>
      <script>
   ...
   <div class="form-group">
     ...
     <input class="form-control"  value="{{$tests['teacher_id']}}" id="teacher_id" type="text" name="teacher_id" placeholder="Teacher ID"></input>
      <script>
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
     ...
     <input class="form-control" value="{{$tests['score']}}"  id="score" type="text" name="score" placeholder="Score"></input>
      <script>
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
     ...
     <input class="form-control"  value="{{$tests['acceptance_quorum']}}" id="acceptance_quorum" type="text" name="acceptance_quorum" placeholder="Acceptance Quorum"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M0 5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V5zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V7a2 2 0 0 1-2-2H3z"/>
     ...
     <input class="form-control"  value="{{$tests['amount']}}"  id="amount" type="text" name="amount" placeholder="amount"></input>
      <script>
  ...
  <path d="M3 8.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0-5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-1z"/>
     ...
     <input class="form-control" value="{{$tests['title']}}"   id="title" type="text" name="title" placeholder="Title"></input>
      <script>
...
<div class="form-group">
     ...
     <input class="form-control"  value="{{$tests['major_id']}}"  id="major_id" type="text" name="major_id" placeholder="Major ID"></input>
      <script>
...
<div class="form-group">
     ...
     <input class="form-control"  value="{{$tests['lesson_id']}}"  id="lesson_id" type="text" name="lesson_id" placeholder="Lesson Id"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z"/>
     ...
     <input class="form-control"  value="{{$tests['date']}}"  id="date" type="text" name="date" placeholder="Date"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M6.5 0a.5.5 0 0 0 0 1H7v1.07A7.001 7.001 0 0 0 8 16a7 7 0 0 0 5.29-11.584.531.531 0 0 0 .013-.012l.354-.354.353.354a.5.5 0 1 0 .707-.707l-1.414-1.415a.5.5 0 1 0-.707.707l.354.354-.354.354a.717.717 0 0 0-.012.012A6.973 6.973 0 0 0 9 2.071V1h.5a.5.5 0 0 0 0-1h-3zm2 5.6V9a.5.5 0 0 1-.5.5H4.5a.5.5 0 0 1 0-1h3V5.6a.5.5 0 1 1 1 0z"/>
     ...
     <input class="form-control"  value="{{$tests['duration']}}"  id="duration" type="text" name="duration" placeholder="Duration"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M14.778.085A.5.5 0 0 1 15 .5V8a.5.5 0 0 1-.314.464L14.5 8l.186.464-.003.001-.006.003-.023.009a12.435 12.435 0 0 1-.397.15c-.264.095-.631.223-1.047.35-.816.252-1.879.523-2.71.523-.847 0-1.548-.28-2.158-.525l-.028-.01C7.68 8.71 7.14 8.5 6.5 8.5c-.7 0-1.638.23-2.437.477A19.626 19.626 0 0 0 3 9.342V15.5a.5.5 0 0 1-1 0V.5a.5.5 0 0 1 1 0v.282c.226-.079.496-.17.79-.26C4.606.272 5.67 0 6.5 0c.84 0 1.524.277 2.121.519l.043.018C9.286.788 9.828 1 10.5 1c.7 0 1.638-.23 2.437-.477a19.587 19.587 0 0 0 1.349-.476l.019-.007.004-.002h.001"/>
     ...
     <input class="form-control"  value="{{$tests['start_time']}}"  id="start_time" type="text" name="start_time" placeholder="Start Time"></input>
      <script>
