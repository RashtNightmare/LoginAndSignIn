...
<!-- 'name','email','identity_card','national_code','mobile','username','password','avatar'
    ...
    <tr style="background-color: #aacc09">
       ...
       <thead> <tr>
           ...
           <td><a href="\test_student\{{$test_students[$i]['id']}}\delete" _blank>Delete</a></td>

        </tr>       <thead>

       @endfor<div class="background-color:white;"><h4><a href="\test_student\create" _blank>Create</a></h4></div>
