...
<form method ="POST" action="\test_student\{{$test_students['id']}}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
{{ csrf_field() }}
{{ method_field('PATCH') }}
    <div class="form-group"><label id="login_label" name="login_label" style="margin-bottom:20px;font: 30px icon;text-align:left"> Test Student {{$test_students['id']}}</label></div>
     ...
     <input class="form-control" value="{{$test_students['user_id']}}" id="user_id" type="text" name="user_id" placeholder="User ID"></input>
      <script>
   ...
   <div class="form-group">
     ...
     <input class="form-control"  value="{{$test_students['test_id']}}"  id="test_id" type="text" name="test_id" placeholder="Test ID"></input>
      <script>
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
     ...
     <input class="form-control" value="{{$test_students['score']}}"   id="score" type="text" name="score" placeholder="Score"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M9.5 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
     ...
     <input class="form-control"  value="{{$test_students['status']}}"  id="status" type="text" name="status" placeholder="Status"></input>
      <script>
...
<div class="form-group">
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
     ...
     <input class="form-control"   value="{{$test_students['paid']}}" id="paid" type="text" name="paid" placeholder="Paid"></input>
      <script>
  ...
  <path d="m8.354 10.354 7-7a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z"/>
     ...
     <input class="form-control"   value="{{$test_students['canceled']}}" id="canceled" type="text" name="canceled" placeholder="Canceled"></input>
      <script>
